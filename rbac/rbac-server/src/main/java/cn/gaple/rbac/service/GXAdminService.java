...
public interface GXAdminService extends GXMyBatisBaseService<GXAdminRepository, GXAdminMapper, GXAdminModel, GXAdminDao, GXAdminDBResDto, Integer> {
    /**
     * 获取当前登录管理员的状态
     *
     * @param adminId 管理员ID
     ...
     * @return 分页对象
     */
    GXPaginationResDto<GXAdminDBResDto> pagination(GXBaseQueryParamInnerDto queryParamReqDto);
}
